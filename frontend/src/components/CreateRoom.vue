<template>
  <div class="_3ozFtOe6WpJEMUtxDOIvtU snipcss-TkYJ3 snip-div">
    ...
    <div class="_31N0dvxfpsO6Ur5AKx4O5d snip-div" style="max-width: 1248px">
      ...
      <!-- right panel sub -->
      <div
        class="_3Kd8DQpBIbsr5E1JcrMFTY _1tvThPWQpORoc2taKebHxs snip-div"
        style="margin-left: 24px; margin-top: 0px"
      >
        <div
          class="itxZANPrH4AAYOj6VgfL9 snipcss0-3-195-196 snipcss-rF1Br snip-div"
        >
          <div class="_1Zj2sAyYL2zB-kzZQcWiW snipcss0-4-196-197 snip-div">
            <div class="_27SYzmGZdspPn9yA9voNCY snipcss0-5-197-198 snip-div">
              <svg
                class="_1XXU14d6sjwsheKLMcy7ro snipcss0-6-198-199"
                xmlns="http://www.w3.org/2000/svg"
                viewbox="0 0 45 43"
              >
                <g fill="none" fill-rule="evenodd" class="snipcss0-7-199-200">
                  <g
                    fill="#0DD3BB"
                    transform="translate(0 4)"
                    class="snipcss0-8-200-201"
                  >
                    <ellipse
                      cx="25.492"
                      cy="22.2631"
            ...
            <ol class="a5fJMl2u0aujwukxWH3if snipcss0-5-197-203">
              ...
              <li class="_2aD4E5YdfsXR-e8kLRuTEp snipcss0-6-203-205 snip-li">
                Behave like you would in real life
              </li>
              <li class="_2aD4E5YdfsXR-e8kLRuTEp snipcss0-6-203-206 snip-li">
                Look for the original source of content
              </li>
              <li class="_2aD4E5YdfsXR-e8kLRuTEp snipcss0-6-203-207 snip-li">
                Search for duplicates before posting
              </li>
              <li class="_2aD4E5YdfsXR-e8kLRuTEp snipcss0-6-203-208 snip-li">
                Read the community’s rules
              </li>
            </ol>
          </div>
          <div
            class="_2vEf-C2keJaBMY9qk_BxVn snipcss0-4-196-209 snip-div"
          ></div>
          <div class="_2N9ShiilNyzdd0B_i9geBj snipcss0-4-196-210 snip-div">
            Please be mindful of reddit's
            <a
              href="https://www.reddit.com/help/contentpolicy"
              class="snipcss0-5-210-211 snip-a"
              >content policy</a
            >
            and practice good
            <a
              href="https://www.reddit.com/wiki/reddiquette"
              class="snipcss0-5-210-212 snip-a"
              >reddiquette</a
            >.
          </div>
        </div>
...
@media (min-width: 960px) {
  ._3Kd8DQpBIbsr5E1JcrMFTY._1tvThPWQpORoc2taKebHxs {
    display: block;
  }
}
